...
// @taxonomy: spec/index
= error-lang — Specification Directory
:toc:

== Overview

This directory contains the canonical language/query specification files for error-lang.

== Contents

=== grammar.ebnf
The canonical EBNF grammar for error-lang.
